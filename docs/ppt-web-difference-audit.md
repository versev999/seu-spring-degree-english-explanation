...
审查目标：逐单元对比 Unit 1-8 PPT 与网页教程，找出影响自学的差异，并把缺失的重点内容和习题补成网页端可学习、可互动的形式。

## 审查原则

- 不把 PPT 截图或整页原样塞进网页。
- 优先补会影响自学的内容：题干、练习材料、判断标准、答案或解析。
- PPT 中仅适合课堂讨论的开放题，网页端改成“题目 + 参考思路”。
- 能做成客观判断的题目，尽量改成 `quiz`、下拉匹配或 True/False 互动题。
- PPT 里依赖教材原文但未提供完整原文的题目，网页端明确说明可用材料或改成分析型任务。
...
- 新增名词化词形下拉题，训练 concerned → concern、argue → argument 等高频词形。
...
已发现差异：
- PPT 有 “Write a submission cover letter for your own manuscript” 任务，网页原来只给说明。
- PPT 有 “Fill in the blanks based on the decision letter” 任务，网页原来只给 major revision 处理清单。

已修正：
- 新增投稿信信息要素互动判断题。
- 新增投稿信可套用框架。
- 新增 decision letter 后续操作排序题。
- 将回复决定信范文标为 Task 2，与 PPT 顺序对齐。
